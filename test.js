...
const firebaseConfig = {
  ...
  function submitForm(e){
    ...
    var midddleName = getElementVal('middleName') ;
    var origin = getElementVal('origin') ;
    var number = getElementVal('number') ;

    saveMessages(firstName, midddleName, lastName, origin, number);
  ...
  var saveMessages = function(firstName, midddleName, lastName, origin, number) {
